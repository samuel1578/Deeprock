...
export const newsArticles: NewsArticle[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'Deep Rock\'s role. Deep Rock operates under a self-financing Aggregator Licence and works with licensed small-scale miners and mining communities. Its public messaging focuses on responsible engagement and market access without presenting the company as a regulator or price-setting authority.',
    ],
    cta: {
      label: 'Discuss a Related Opportunity',
      href: '/contact',
  ...
  },
  {
    ...
    content: [
      ...
      'A visible organisational commitment. Deep Rock lists safety among its core values and includes Health, Safety and Environment leadership within its management structure. The website makes that commitment visible while avoiding unsupported claims such as injury-free hours or certifications that have not been verified.',
    ],
    cta: {
      label: 'Discuss a Related Opportunity',
      href: '/contact',
  ...
  },
  {
    ...
    content: [
      ...
      'Integrated technical support. Geological consulting becomes more useful when it connects with exploration planning, mining operations, equipment needs and environmental responsibilities. Deep Rock\'s service portfolio is designed to present these areas as related capabilities rather than isolated offerings.',
  ...
  },
  {
    ...
    content: [
      ...
      'Evidence before claims. Deep Rock\'s website communicates principles and approved activities. It must not publish invented carbon targets, rehabilitation statistics, community-investment figures or certification logos. Credibility is stronger when claims are specific, evidence-based and properly approved.',
    ],
    cta: {
      label: 'Discuss a Related Opportunity',
      href: '/contact',
  ...
  },
  {
    ...
    content: [
      ...
      'A scalable service model. Deep Rock\'s current service portfolio includes mining support, equipment supply, geological consulting, exploration, operations and environmental services. The website groups these capabilities so prospective partners can understand how they relate and submit a focused enquiry.',
    ],
    cta: {
      label: 'Discuss a Related Opportunity',
      href: '/contact',
