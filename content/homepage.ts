...
export const heroSlides: HeroSlide[] = [
  {
    ...
    summary: 'Deep Rock Mining Co. Ltd connects precious minerals trading, aggregation and responsible mining services through transparent commercial relationships.',
    primaryCTA: {
...
export const companyIntroductionContent = {
  ...
  body: 'Deep Rock Mining Co. Ltd specialises in precious minerals trading, particularly the buying and selling of gold, as well as responsible mining operations under a self-financing Aggregator Licence. Our work includes sourcing, purchasing, aggregating and marketing gold while supporting sustainable mining and technical activities.\n\nWe work closely with licensed small-scale miners, mining communities, investors, technical partners and institutions. Our aim is to provide reliable market access and responsible service solutions while operating with integrity, transparency and respect for applicable requirements.',
...
export const aggregationFeatureContent = {
  ...
  body: 'Through its self-financing aggregation model, Deep Rock Mining Co. Ltd works with licensed small-scale miners and mining communities to support responsible gold sourcing, purchasing and aggregation. Our focus is clear communication, commercial reliability and relationships designed for long-term value.',
  steps: [
    {
      number: '01',
...
export const partnershipCTAContent = {
  heading: 'Build the Next Opportunity with Deep Rock Mining Co. Ltd',
